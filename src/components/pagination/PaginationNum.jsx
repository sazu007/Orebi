  ...
  <ul class="flex items-center justify-center -space-x-px h-8 text-sm py-10">
    <li onClick={prve}>
     ...
     {pageNumber.map((item,i)=>(
        ...
        <li onClick={()=>paginate(item)} className={currentPage == i + 1 ? "flex items-center justify-center px-3 h-8 leading-tight text-white bg-gray-800 border border-gray-300" : "flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300"}>
