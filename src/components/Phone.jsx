...
<Container> 
    <Flex> 
        <div className="flex justify-between]">
            ...
            <div className="w-[56%] pl-2 mt-[-5px] lg:mt-0">
                ...
                <p className='font-dm  text-[12px]  lg:text-base text-[#262626] w-[200px] lg:w-[600px] pb-1 text-justify'>Lorem Ipsum is simply dummy text of the printing and typesetting industry orem Ipsum..</p>
