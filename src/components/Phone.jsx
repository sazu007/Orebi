    ...
    {/* <Flex>  */}
        <div className="flex justify-between]">
            <div className="w-[38%] pl-2">
                <img className="h-[105px] lg:h-full w-full" src={Phoneimg} alt="phone" />
            </div>
            <div className="w-[58%] pl-2 mt-[-5px] lg:mt-0">
                ...
                <p className='font-dm  text-[12px]  lg:text-base text-[#262626] w-[200px] md:w-[800px] lg:w-[600px] pb-1 text-justify'>Lorem Ipsum is simply dummy text of the printing and typesetting industry orem Ipsum..</p>
